...
public class MConf extends Entity<MConf>
{
	...
	private Map<String, String> rewards = MUtil.map(
		...
		"Antique Bed Frame", "give {m} bed 1 name:&aAntique_Bed_Frame lore:A_lovely_bedframe_salvaged_from_a_long|gone_noble_estate._Probably_stolen. lure:1 unbreaking:2give {m} 371 1 name:&aA_Regal lore:A_single_regal,_not_worth_much.|A_regal_for_your_thoughts? fortune:1",
		"Squid Baby", "give {m} inksac 1 name:&aSquid_Baby lore:A_most_precious_baby_squid.|Protect_it_with_your_life.give {m} 371 1 name:&aA_Regal lore:A_single_regal,_not_worth_much.|A_regal_for_your_thoughts? fortune:1",
		"Apple of my Eye", "give {m} apple 1 name:&aApple_of_My_Eye lore:OH_NO!_PUT_THAT_BACK!|IT'S_COVERED_IN_BLOOD! punch:2give {m} 371 1 name:&aA_Regal lore:A_single_regal,_not_worth_much.|A_regal_for_your_thoughts? fortune:1",
		"Head Cage", "give {m} stained_glass:11 1 name:&aHead_Cage lore:Keep_your_thoughts_safe! protection:5give {m} 371 1 name:&aA_Regal lore:A_single_regal,_not_worth_much.|A_regal_for_your_thoughts? fortune:1",
		"Fireflies in a Jar", "give {m} ??? 1 name:&aFireflies_in_a_Jar lore:Glowing_bugs_make_perfect_nightlights.|No_longer_will_monsters_under_the|bed_plague_this_holy_land! protection:2give {m} 371 1 name:&aA_Regal lore:A_single_regal,_not_worth_much.|A_regal_for_your_thoughts? fortune:1",
		"Sea Monkeys", "give {m} 373 1 name:&aSea_Monkeys lore:&r&7Fragile_III&5&o|It_may_not_look_like_much|but_there_are_itty_bitty_shrimp|just_waiting_to_hatch! give {m} 371 1 name:&aA_Regal lore:A_single_regal,_not_worth_much.|A_regal_for_your_thoughts? fortune:1",
		"Literally Nothing", "give {m} glass 1 name:&aLiterally_Nothing lore:There_is_literally_nothing_in_this_glass_box.give {m} 371 1 name:&aA_Regal lore:A_single_regal,_not_worth_much.|A_regal_for_your_thoughts? fortune:1",
		"Chef's Toque", "give {m} 298 1 name:&aChef's_Toque color:247,247,247 lore:&r&7Skill_III&5&o|A_pristine_white_chef's_toque.|Worn_by_the_master_of_the_kitchen. power:2give {m} 371 1 name:&aA_Regal lore:A_single_regal,_not_worth_much.|A_regal_for_your_thoughts? fortune:1",
		"Chef's Apron", "give {m} 299 1 name:&aChef's_Apron color:247,247,247 lore:&r&7Skill_II&5&o|A_well_made_white_chef's_apron.|A_must_have_for_any_chef. protection:2give {m} 371 1 name:&aA_Regal lore:A_single_regal,_not_worth_much.|A_regal_for_your_thoughts? fortune:1",
		"Diamond Ring", "give {m} 264 1 name:&aDiamond_Ring lore:A_golden_band_with_a_large_diamond_set_in_it.|This_must_be_worth_a_fortune. unbreaking:3 sharpness:1 fortune:3give {m} 371 1 name:&aA_Regal lore:A_single_regal,_not_worth_much.|A_regal_for_your_thoughts? fortune:1",
		"Rotten Toadstool", "give {m} 40 1 name:&aRotten_Toadstool lore:&r&7Gross_II&5&o|Why_would_anyone_want_this?|The_smell_alone_might_kill_you. sharpness:1give {m} 371 1 name:&aA_Regal lore:A_single_regal,_not_worth_much.|A_regal_for_your_thoughts? fortune:1",
		"Treeheart Gem Necklace", "give {m} 388 1 name:&aTreeheart_Gem_Necklace lore:A_beautiful_silver_necklace_centered|with_a_humble_green_gem_taken_from_the|middle_of_a_tree_affected_by_Evergrowth_Magic.give {m} 371 1 name:&aA_Regal lore:A_single_regal,_not_worth_much.|A_regal_for_your_thoughts? fortune:1",
